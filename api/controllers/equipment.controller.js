...
//create suplier
export const createequiment = async (req, res, next) => {
...
//get all suplier
export const getAllequiment = async (req, res, next) => {
  try {
...
//delete suplier
export const deleteequiment = async (req, res, next) => {
...
//update suplier
export const updateequiment = async (req, res, next) => {
