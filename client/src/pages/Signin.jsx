  ...
  return (
    <div className="  min-h-screen ">
      ...
      <div className="absolute transform -translate-x-0 translate-y-0 top-1  flex justify-center items-center">
        <div className="">
          <div className=" mt-36 lg:ml-[480px] md:ml-[240px] ml-[4px] ">
            ...
            <div className="bg-white bg-opacity-10 w-[480px]  md:w-[550px] lg:w-[550px] border h-96 mt-8 max-w-3xl mx-auto rounded-3xl border-opacity-60 ">
              <div className="flex justify-center items-center   ">
                <div className="mt-16">
                  <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-950 opacity-70 ml-1">
                        Password
                      </h3>
                      <input
